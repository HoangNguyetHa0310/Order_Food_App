...
public class SliderAdapter extends RecyclerView.Adapter<SliderAdapter.Silderviewholder> {
    ...
    @NonNull
    @Override
    public SliderAdapter.Silderviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();

        return new Silderviewholder(LayoutInflater.from(parent.getContext()).inflate(R.layout.silder_viewholder,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull SliderAdapter.Silderviewholder holder, int position) {
